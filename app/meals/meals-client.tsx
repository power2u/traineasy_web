...
export function MealsClient({ userId, initialData }: MealsClientProps) {
    const { meals, history, isLoading, toggleMeal: toggleMealMutation, isToggling } = useMealsData(userId, {
    ...
    return (
        <div className="p-6 max-w-4xl mx-auto">
            ...
            {/* Wellness Check-In */}
            <WellnessCheckIn userId={userId} initialCheckIn={initialData.wellnessCheckIn} />
        </div>
    );
}
