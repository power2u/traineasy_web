...
const shouldAutoStartScheduler =
  process.env.NODE_ENV === 'production' &&
  typeof window === 'undefined' &&
  process.env.INTERNAL_SCHEDULER_AUTO_START === 'true';

if (shouldAutoStartScheduler) {
  console.log('📅 Auto-starting scheduler in production runtime...');
  ...
  console.log('🔧 Scheduler not auto-started (missing INTERNAL_SCHEDULER_AUTO_START or non-production)');
}
